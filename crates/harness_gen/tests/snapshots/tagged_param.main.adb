...
begin
   loop
      ...
      AdaFuzz.Probe.Set_Target (16#000F#);
      begin
      declare
         Cur : AdaFuzz.Decode.Cursor := AdaFuzz.Decode.Open (Buf'Unchecked_Access, Last);
         function Decode_Obj return Root_Type is
         begin
            case AdaFuzz.Decode.Choose_Tag (Cur, 1) is
               when 1 => return Make_Root;
               when others => return Make_Root;
            end case;
         end Decode_Obj;
